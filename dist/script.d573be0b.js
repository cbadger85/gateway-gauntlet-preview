...
var gauntletDate = Date.parse('29 Jun 2019 15:00:00 GMT');
var msToGauntlet = gauntletDate - todaysDate;
var daysRemainingAlert = document.querySelector('#days-remaining');

msToDays = function msToDays(ms) {
  return ms / 1000 / 60 / 60 / 24;
};

var daysToGauntlet = Math.floor(msToDays(msToGauntlet));
daysRemainingAlert.innerHTML += "<p class=\"mb-0\">There are only ".concat(daysToGauntlet, " days until the 2019 Gateway Gauntlet!</p>");
